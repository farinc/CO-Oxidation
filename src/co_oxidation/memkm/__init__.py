...
`generate_model(k_o_ads, tile)` builds the master-equation generator for the CO
oxidation mechanism and needs only `me_mkm`. `CoexistencePipeline` locates the
coexistence point(s) k_o_ads* and the basin transition rates from its spectrum;
